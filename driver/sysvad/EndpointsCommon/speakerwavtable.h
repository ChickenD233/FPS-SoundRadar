...
// SoundRadar VAD: host pin supports stereo and 7.1 (8ch) PCM formats,
// 16 or 32 bits per sample, 24-96KHz. Default format is 48KHz/16-bit/8ch.
...
KSDATAFORMAT_WAVEFORMATEXTENSIBLE SpeakerHostPinSupportedDeviceFormats[] =
{
    ...
    { // 6 : 48KHz, 16-bit, 7.1 surround (default host format)
        {
            sizeof(KSDATAFORMAT_WAVEFORMATEXTENSIBLE),
            0,
            0,
...
{
    {
        ...
        &SpeakerHostPinSupportedDeviceFormats[6].DataFormat  // 48KHz, 16-bit, 7.1
    },
    {
...
//=============================================================================
//
// Custom pin name GUID for the speaker loopback pin. Registered in the INF
// under MediaCategories so the loopback capture endpoint gets its own
// friendly name. NOTE: this GUID is SoundRadar VAD specific.
//
const GUID SOUNDRADAR_LOOPBACK_PIN_NAME_GUID =
{0x7C9B4A2E, 0x3D5F, 0x4E1A, {0x9B, 0x6C, 0x8D, 0x2E, 0x5F, 0x7A, 0x1C, 0x04}};
...
PCPIN_DESCRIPTOR SpeakerWaveMiniportPins[] =
{
    ...
    // Wave Out Streaming Pin (Renderer) KSPIN_WAVE_RENDER_SINK_LOOPBACK
    {
        ...
        NULL,
        {
            ...
            &SOUNDRADAR_LOOPBACK_PIN_NAME_GUID,
            0
        }
    },
