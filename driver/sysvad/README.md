...
`devcon install ComponentizedAudioSample.inf Root\SoundRadarVAD`
...
`C:\\tools\\devcon install ComponentizedAudioSample.inf Root\SoundRadarVAD`

This installs the base Tablet Audio Sample driver with a hardware ID of "Root\SoundRadarVAD".
